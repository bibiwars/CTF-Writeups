...
```
Looks like Hex values, removing spaces

```
cat hype_key.txt | tr -d ' '
```

and decoding using https://www.rapidtables.com/convert/number/hex-to-ascii.html

We get a private key, which I then put in "key" file
...
one of the privesc exploits worth looking at is **DirtyCow**..
```
